...
sudo zypper install -t pattern 'devel_basis.x86_64' 'dkms.x86_64'
#wget http://download.virtualbox.org/virtualbox/${GUEST_ADDITION_VERSION}/${GUEST_ADDITION_ISO}
sudo zypper install http://download.virtualbox.org/virtualbox/${GUEST_ADDITION_VERSION}/${GUEST_ADDITION_ISO}
